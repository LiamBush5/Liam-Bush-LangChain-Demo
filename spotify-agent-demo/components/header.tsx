...
export function Header({ serverStatus, onRefreshStatus }: HeaderProps) {
    return (
        <header className="bg-[#121212] border-b border-[#282828] px-6 py-3 flex-shrink-0">
            <div className="flex items-center justify-center w-full">
                {/* Spotify Logo and AI Agent - Centered */}
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white/90 text-sm font-medium">AI Agent</span>
                </div>
            </div>
        </header>
    )
